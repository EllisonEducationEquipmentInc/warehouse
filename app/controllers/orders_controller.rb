class OrdersController < ApplicationController
  ...
  def destroy
    ...
    csv_string = CSV.generate do |csv|
      ...
      @orders.each do |o|
        csv << [o.product.item_num, o.quantity, "EA", o.price, "", "", "#{order_prefix}#{o.order_id}", o.order.sub_total, o.order.sales_tax, o.order.total, o.order.email, o.order.business, o.order.contact, o.order.phone, o.order.address, o.order.payment_method, o.order.tax_exempt, o.order.tax_exempt_number, o.order.notes, o.product.start_date, o.item_total, o.created_at, o.updated_at, o.customer_number, o.product.start_date.try(:strftime, "%B"), o.product.start_date.try(:strftime, "%Y")]
      end
    end
