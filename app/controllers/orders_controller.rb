class OrdersController < ApplicationController
  ...
  def destroy
    ...
    csv_string = FasterCSV.generate do |csv|
      ...
      @orders.each do |o|
        csv << [o.product.item_num, "", "", "", o.quantity, "EA", o.price, "", "", "CHAS#{o.order_id}", o.order.sub_total, o.order.sales_tax, o.order.total, o.order.email, o.order.business, o.order.contact, o.order.phone, o.order.address, o.order.notes, o.product.start_date, o.item_total, o.created_at, o.updated_at]
      end
    end
