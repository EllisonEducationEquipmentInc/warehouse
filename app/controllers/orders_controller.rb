class OrdersController < ApplicationController
  ...
  def export_to_csv
    ...
    csv_string = CSV.generate do |csv|
      ...
      @orders.each do |o|
        csv << [o.product.item_num, o.quantity, "EA", o.product.try(:price), o.product.price - o.price, "", o.item_total, o.order.sub_total, o.order.total, o.order.sales_tax, o.order.customer_number, "#{order_prefix}#{o.order_id}",  o.ship_month, o.order.employee_number, o.order.coupon_code, "", o.order.notes, o.order.email, o.order.business, o.order.contact, o.order.phone, o.order.address, o.order.city, o.order.state, o.order.zip_code, o.order.country, o.order.payment_method, o.order.tax_exempt, o.order.tax_exempt_number,  o.product.start_date,  o.created_at, o.updated_at,  o.product.start_date.try(:strftime, "%B"), o.product.start_date.try(:strftime, "%Y"),  o.order.full_name,   o.ship_month.try(:strftime, "%B"), o.ship_month.try(:strftime, "%Y")]
      end
    end
